  ...
  <div class="col-md-6 col-sm-12">
    <div class="container">
      <div class="text-background" style="margin-left: 114px; margin-top: 135px;">
        <h2 class="col-md-7 mx-auto text-black " style="font-size: 30px;">Up to 50% off </h2>
    ...
    @foreach ($categories as $product)
          <div id="product" class="col-lg-3 col-md-3 col-xm-3 col-sm-6 col-xm-6 " style="margin-bottom: 23px;">
            <div class="content">
              ...
              <div class="pimg">
                  <a href="{{ url('category_detail/' .$product->slug)}}">
...
<form class="form-inline md-form mr-auto" style="margin-top: 29px;">
  <input class="form-control mr-sm-2" type="text" placeholder="input whatsapp no" aria-label="Search">
  <button class="btn btn-unique btn-rounded btn-sm my-0 waves-effect waves-light" type="submit">Submit</button>
</form>
...
<h3 class="ig-experience">Share your Rumple Experience #iwearrumples</h3>
